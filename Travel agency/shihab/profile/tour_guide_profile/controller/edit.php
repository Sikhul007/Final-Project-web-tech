...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE tour_guide SET name='$name', email='$email', phone='$phone', dob='$dob', gender='$gender', picture='$picture' WHERE id=$id";
...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM tour_guide WHERE id = $userId";
