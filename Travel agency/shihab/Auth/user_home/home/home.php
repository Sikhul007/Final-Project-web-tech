...
<body>
    ...
    <form action="../../user_dashboard.php"><button class="signin-btn">Profile</button></form>
    ...
    <div>
        <form action="../../../../nafis/view/customplan/customplan.php">
            <button class="customPlan">Custom Plan</button>
        </form>
        <form action="../../../../nafis/view/tourpackage/package.php">
            <button class="package">Package Plan</button>
        </form>
    </div>
